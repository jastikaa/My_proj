...
static constexpr auto qt_meta_stringdata_ZN5writeE = QtMocHelpers::stringData(
    "write",
...
Q_CONSTINIT static const uint qt_meta_data_ZN5writeE[] = {
...
Q_CONSTINIT const QMetaObject write::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5writeE.offsetsAndSizes,
    qt_meta_data_ZN5writeE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5writeE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<write, std::true_type>,
...
void *write::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5writeE.stringdata0))
